...
async function loadQuestions() {
    ...
    //get the container
    const questionContainer = document.getElementById("PoliciesContainer");

    //filter only adaptation(visually impaired) questions
    const adaptationsQuestions =
        questions.filter(question =>
            question.section === "Policies"
        );
...
async function calculateScore() {
    ...
    try {
        ...
        await setDoc(
            doc(db, "institutions", user.uid, "assessments", "policies"),
            {
                score: totalScore,
        ...
        alert("Policies assessment saved!");
