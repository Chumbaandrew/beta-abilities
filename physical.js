...
async function loadQuestions() {
    ...
    //get the container
    const questionContainer = document.getElementById("PhysicalContainer");

    //filter only adaptation(visually impaired) questions
    const adaptationsQuestions =
        questions.filter(question =>
            question.section === "Adaptations"
        );
...
async function calculateScore() {
    ...
    try {
        ...
        await setDoc(
            doc(db, "institutions", user.uid, "assessments", "physical"),
            {
                score: totalScore,
        ...
        alert("Physical assessment saved!");
